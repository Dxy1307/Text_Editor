...
public class MarkovTextGeneratorLoL implements MarkovTextGenerator {
	...
	public void train(String sourceText)
	{
		...
		for(int i = 1; i < len; i++) {
			...
			ListNode currNode = checkListNode(prevWord);
			if(currNode != null) {
				currNode.addNextWord(currWord);
			} else {
...
//		wordList.get(wordList.size() - 1).addNextWord(starter);
	...
	private ListNode checkListNode(String word) {
	...
	public String generateText(int numWords) {
		...
		for(int i = 1; i < numWords; i++) {
			ListNode node = checkListNode(currWord);
...
//		int randomInt = 0;
//		if(nextWords.size() > 1) {
//			randomInt = generator.nextInt(nextWords.size());
//		}
